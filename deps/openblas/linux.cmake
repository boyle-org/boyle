...
if(CMAKE_C_COMPILER_ID STREQUAL "GNU" AND CMAKE_Fortran_COMPILER_ID STREQUAL "GNU")
  ...
  set(_OPENBLAS_LDFLAGS -fuse-ld=bfd\ ${_OPENBLAS_LINK_OPTIONS_IPO})
...
elseif(CMAKE_C_COMPILER_ID STREQUAL "Clang" AND CMAKE_Fortran_COMPILER_ID STREQUAL "LLVMFlang")
  ...
  set(_OPENBLAS_CFLAGS ${_OPENBLAS_ASMFLAGS})
  set(_OPENBLAS_FFLAGS ${CMAKE_Fortran_FLAGS}\ ${CMAKE_Fortran_FLAGS_${_OPENBLAS_BUILD_TYPE_UPPER}}\ ${_OPENBLAS_COMPILE_OPTIONS_IPO})
  set(_OPENBLAS_LDFLAGS -fuse-ld=lld\ -rtlib=compiler-rt\ ${_OPENBLAS_LINK_OPTIONS_IPO})
...
if(BUILD_SHARED_LIBS)
  ...
  set(_OPENBLAS_BUILD_BYPRODUCTS ${CMAKE_CURRENT_BINARY_DIR}/_deps/openblas-build/libopenblas.so)
  set(_OPENBLAS_INSTALL_BYPRODUCTS ${CMAKE_CURRENT_BINARY_DIR}/_deps/openblas-install/lib/libopenblas.so)
else()
...
if(BUILD_SHARED_LIBS)
  target_link_libraries(blas_lapack INTERFACE
    "$<BUILD_INTERFACE:${_OPENBLAS_INSTALL_DIR}/lib/libopenblas.so>"
