package("qdldl")
    ...
    add_configs("shared", {description = "Build qdldl as a shared library.", default = false, type = "boolean"})
...
add_requires("qdldl 0.1.9", {configs = {shared = is_config("kind", "shared")}})
