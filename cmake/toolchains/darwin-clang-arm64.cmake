...
set(CMAKE_C_FLAGS "-march=armv8-a -mtune=generic -pipe -fPIC -fexceptions -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -fno-plt -Wall -Wextra -Wpedantic -Wno-psabi" CACHE STRING "C compiler flags")
set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS} -stdlib=libc++" CACHE STRING "C++ compiler flags")
set(CMAKE_Fortran_FLAGS "-march=armv8-a -mtune=generic -fPIC -fno-omit-frame-pointer -pedantic" CACHE STRING "Fortran compiler flags")
...
set(CMAKE_EXE_LINKER_FLAGS "-L${_HOMEBREW_LLVM_PREFIX}/lib/c++ -L${_HOMEBREW_LLVM_PREFIX}/lib/unwind -stdlib=libc++ -rtlib=compiler-rt --unwindlib=libunwind -lc++abi -Wno-psabi" CACHE STRING "Executable linker flags")
set(CMAKE_SHARED_LINKER_FLAGS "-L${_HOMEBREW_LLVM_PREFIX}/lib/c++ -L${_HOMEBREW_LLVM_PREFIX}/lib/unwind -stdlib=libc++ -rtlib=compiler-rt --unwindlib=libunwind -lc++abi -Wno-psabi" CACHE STRING "Shared linker flags")
set(CMAKE_MODULE_LINKER_FLAGS "-L${_HOMEBREW_LLVM_PREFIX}/lib/c++ -L${_HOMEBREW_LLVM_PREFIX}/lib/unwind -stdlib=libc++ -rtlib=compiler-rt --unwindlib=libunwind -lc++abi -Wno-psabi" CACHE STRING "Module linker flags")
