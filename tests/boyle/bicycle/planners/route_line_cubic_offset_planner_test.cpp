/**
 * @file route_line_cubic_offset_planner_test.cpp
...
#include "boyle/bicycle/planners/route_line_cubic_offset_planner.hpp"
...
TEST_CASE("LaneFollow") {
    ...
    SUBCASE("BentLane") {
        ...
        RouteLineCubicOffsetPlanner<::boyle::math::Vec2d> route_line_offset_planner{
...
auto main(int argc, const char* argv[]) -> int {
    cxxopts::Options options(
        "route_line_cubic_offset_planner_test", "unit test of RouteLineCubicOffsetPlanner class"
    );
    options.add_options()(
