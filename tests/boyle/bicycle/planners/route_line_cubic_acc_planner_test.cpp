/**
 * @file route_line_cubic_acc_planner_test.cpp
...
#include "boyle/bicycle/planners/route_line_cubic_acc_planner.hpp"
...
TEST_CASE("CostTest") {
    ...
    RouteLineCubicAccPlanner<double> route_line_acc_planner{sample_ts};
...
TEST_CASE("TrivialScene") {
    ...
    RouteLineCubicAccPlanner<double> route_line_acc_planner{sample_ts};
    route_line_acc_planner.setInitialState(0.0, 0.0);
    route_line_acc_planner.setFinalState(100.0, 0.0);
    ...
    CHECK_EQ(motion.eval(10.0), doctest::Approx(50.0).epsilon(1E1));
...
TEST_CASE("HeadwayScene") {
    ...
    SUBCASE("Yield") {
        route_line_acc_planner.setInitialState(0.0, 20.0, 0.0);
    ...
    SUBCASE("Overtake") {
        route_line_acc_planner.setInitialState(0.0, 10.0, 0.0);
...
auto main(int argc, const char* argv[]) -> int {
    cxxopts::Options options(
        "route_line_cubic_acc_planner_test", "unit test of RouteLineCubicAccPlanner class"
    );
    options.add_options()(
