target("math_mdfunction_proxy_test")
    ...
    add_deps("math_mdfunction_proxy", "math_vector", "math_vectorx", "math_matrix", "math_matrixx", "math_linear_mdfunction", "math_quadratic_mdfunction", "math_rosenbrock_function")
target_end()
