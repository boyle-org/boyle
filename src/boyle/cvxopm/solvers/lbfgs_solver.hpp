...
struct LbfgsSolver final {
    ...
    LbfgsSolver() noexcept = delete;
    LbfgsSolver(const LbfgsSolver& other) noexcept = delete;
    auto operator=(const LbfgsSolver& other) noexcept -> LbfgsSolver& = delete;
    LbfgsSolver(LbfgsSolver&& other) noexcept = delete;
    auto operator=(LbfgsSolver&& other) noexcept -> LbfgsSolver& = delete;
    ~LbfgsSolver() noexcept = default;

    [[using gnu: always_inline]]
    explicit LbfgsSolver(const Settings<value_type, index_type>& c_settings) noexcept
        : settings{c_settings} {}
